...
function EventDispatcher () as Object
  ...
  prototype.addEventListener = sub(eventType as String, handlerName as String, context as Object) as void
  ...
  prototype.dispatchEvent = sub(eventType as String, payload=Invalid as Dynamic) as void
  ...
  ' @param context      The context object.
  prototype.removeEventListener = sub(eventType as String, handlerName as String, context as Object) as void
    eventTypeListeners = m._listeners[eventType]
